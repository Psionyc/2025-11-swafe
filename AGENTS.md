...
* For explanations, discussions, analysis, and summaries: use **Simplified English**.
* All code, comments, identifiers (variable names, function names, type names, etc.), commit messages, and content within Markdown code blocks: use **English** entirely, no English characters allowed.
* In Markdown documents: body text uses English, all content within code blocks uses English.
